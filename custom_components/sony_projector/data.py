...
The SonySDCPConfigEntry type alias is used throughout the integration
...
if TYPE_CHECKING:
    ...
    from .api import SonySDCPApiClient
    from .coordinator import SonySDCPDataUpdateCoordinator


type SonySDCPConfigEntry = ConfigEntry[SonySDCPData]
