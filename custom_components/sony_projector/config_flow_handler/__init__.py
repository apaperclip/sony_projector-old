...
The main config flow handler is imported in config_flow.py at the integration root:
    ...
    from .config_flow_handler import SonySDCPConfigFlowHandler
...
from .config_flow import SonySDCPConfigFlowHandler
from .options_flow import SonySDCPOptionsFlow
