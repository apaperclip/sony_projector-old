...
Find all entities in **Settings** → **Devices & Services** → **SonySDCP** → click on the device.
...
4. Check the integration diagnostics (Settings → Devices & Services → SonySDCP → 3 dots → Download diagnostics)
