...
from custom_components.sony_projector.api import SonySDCPApiClientAuthenticationError, SonySDCPApiClientError
...
class SonySDCPDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: SonySDCPConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except SonySDCPApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="sony_projector",
                translation_key="authentication_failed",
            ) from exception
        except SonySDCPApiClientError as exception:
