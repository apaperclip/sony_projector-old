...
if TYPE_CHECKING:
    from custom_components.sony_projector.config_flow_handler.options_flow import SonySDCPOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "SonySDCPApiClientAuthenticationError": "auth",
    "SonySDCPApiClientCommunicationError": "connection",
}


class SonySDCPConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
...
__all__ = ["SonySDCPConfigFlowHandler"]
