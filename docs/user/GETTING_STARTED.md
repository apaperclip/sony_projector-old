# Getting Started with SonySDCP

This guide will help you install and set up the SonySDCP custom integration for Home Assistant.
...
7. Click "Add"
8. Find "SonySDCP" in the integration list
9. Click "Download"
...
4. Select entities from "SonySDCP"
