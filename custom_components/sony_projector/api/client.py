...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        SonySDCPApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise SonySDCPApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class SonySDCPApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            SonySDCPApiClientAuthenticationError: If authentication fails.
            SonySDCPApiClientCommunicationError: If communication fails.
            SonySDCPApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise SonySDCPApiClientCommunicationError(
                msg,
            ) from exception
